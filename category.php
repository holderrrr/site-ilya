...
<center>
 ...
 <div class="form-item">
	...
	<br/>
	<h1>Коммуникации</h1>
	<div type="div" class="butpopup" onclick="electroSum()" id="kanal" ><i class=" fa fa-check fa-lg" id="electroicon" aria-hidden="true" style="margin-right: 5px;display: none;" ></i>Електричество</div>
...
<div style="position: fixed;z-index: 101;left: 0%;" class="asdtest butpopup" id="popup" onclick="div_show()">РАССЧИТАТЬ<br/>СТОИМОСТЬ</div>
      <div class="wrapper-fluid list-example">
        <div class="wrapper">
		<?php
		/* Start the Loop */
		...
		<div class="item-example-block">
		  <div class="wrap-img">
			<div class="price"><?php echo get_field('цена',$value);?> руб.</div> 
		<!--	<a href="#"><div class="price butpopup" id="popup" onclick="div_show()">РАССЧИТАТЬ СТОИМОСТЬ</div></a> -->
			...
			<a href="<?php echo get_permalink($value);?>">
		  <div class="wrap-text">
			<h3><?php echo get_the_title($value);?></h3>
			<p><?php echo get_field('заголовок',$value);?></p>
			<h4><?php echo get_field('подзаголовок',$value);?></h4>
			<div class="area">
						<div class="text">Площадь</div>
						<div class="volue"><?php the_field('площадь');?> m<sup>2</sup></div>
					</div>
		  </div></a>
		</div>
